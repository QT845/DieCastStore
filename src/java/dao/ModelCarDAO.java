...
public class ModelCarDAO implements IDAO<ModelCar, String> {
    ...
    private String getPrefixByBrandId(int brandId) throws SQLException, ClassNotFoundException {
        Connection c = null;
        PreparedStatement st = null;
        ResultSet rs = null;
        try {
    ...
    private String generateModelCarId(String prefix) throws ClassNotFoundException, SQLException {
        Connection c = null;
        PreparedStatement st = null;
        ResultSet rs = null;
        try {
